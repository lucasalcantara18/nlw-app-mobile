        ...
        <ImageBackground source={require('../../assets/home-background.png')} imageStyle={{width: 274, height: 368}}  style={styles.container}>
            <View style={styles.main}>
                ...
                <View>
                  ...
                  <Text style={styles.description}>Ajudamos Textessoas a encontrarem pontos de coleta de forma eficiente.</Text>
                </View>
            </View>
            <View style={styles.footer}>
              ...
              <RectButton style={styles.button} onPress={handleNavigationsPoints}>
